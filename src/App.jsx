            ...
            <div>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:"10px" }}>
                {werkdagen.map(dag => {
                  ...
                  return (
                    <div key={dagStr} style={{ display:"flex", gap:"10px", alignItems:"stretch" }}>
                    {/* Dagkaartje - vaste afmeting */}
                    <div style={{
                      flex:1,
                    ...
                    {/* Audit kolom - aparte box naast het kaartje */}
                    <div style={{ width:"160px", display:"flex", flexDirection:"column", gap:"6px", justifyContent:"center" }}>
                      {dagAudits.map(a => (
                        <div key={a.id} style={{ background:"rgba(230,126,34,0.1)", border:"1px solid rgba(230,126,34,0.3)", borderRadius:"10px", padding:"8px 10px" }}>
                          <div style={{ fontSize:"10px", color:"rgba(230,126,34,0.6)", textTransform:"uppercase", letterSpacing:"1px", marginBottom:"2px" }}>🔍 Audit</div>
                          <div style={{ fontSize:"12px", fontWeight:"bold", color:"#E67E22" }}>{a.bedrijf}</div>
                          {a.opmerking && <div style={{ fontSize:"10px", color:"rgba(230,126,34,0.6)", marginTop:"2px" }}>{a.opmerking}</div>}
                        </div>
                      ))}
                      {labBezoek.map(a => (
                        <div key={"lab-"+a.id} style={{ background:"rgba(74,158,224,0.1)", border:"1px solid rgba(74,158,224,0.3)", borderRadius:"10px", padding:"8px 10px" }}>
                          <div style={{ fontSize:"10px", color:"rgba(74,158,224,0.6)", textTransform:"uppercase", letterSpacing:"1px", marginBottom:"2px" }}>🏭 Labbezoek</div>
                          <div style={{ fontSize:"12px", fontWeight:"bold", color:"#4A9EE0" }}>{a.bedrijf}</div>
                          {a.labTijd && <div style={{ fontSize:"11px", color:"rgba(74,158,224,0.8)", marginTop:"2px" }}>🕐 {a.labTijd}</div>}
                          {a.opmerking && <div style={{ fontSize:"10px", color:"rgba(74,158,224,0.6)", marginTop:"2px" }}>{a.opmerking}</div>}
                        </div>
                      ))}
