    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0F1923 0%, #162233 50%, #0F1923 100%)", fontFamily: "Georgia, serif", color: "#E8EDF2" }}>
      ...
      {bevestigingToast && (
        ...
        {adminSub === "jaar" && (() => {
          ...
          function exportPDF() {
            document.body.classList.add("printing-jaar");
            window.print();
            setTimeout(() => document.body.classList.remove("printing-jaar"), 1000);
          }
            ...
            <div className="jaaroverzicht-print">
              <div className="no-print" style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "24px", flexWrap: "wrap" }}>
                ...
                <div style={{ display: "flex", gap: "12px", marginLeft: "16px", fontSize: "12px", color: "#7A9AB5", flexWrap: "wrap", flex: 1 }}>
                  ...
                  <span><span style={{ display: "inline-block", width: "12px", height: "12px", borderRadius: "3px", background: "rgba(232,200,56,0.75)", marginRight: "5px", verticalAlign: "middle" }}/>Goedgekeurd</span>
              ...
              <div className="print-only-title" style={{ display: "none" }}>
                <div style={{ fontSize: "18px", fontWeight: "bold", marginBottom: "12px", color: "#000" }}>
                  🌴 VakantieFlow — Jaaroverzicht {jaarKeuze}
                </div>
              </div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", marginBottom: "4px" }}>
                    ...
                    <div style={{ display: "flex", gap: "0" }}>
                      {maanden.map((mNaam, mIdx) => {
                        ...
                        return (
                          <div key={mIdx} className="maand-label" style={{ width: `${breedte}px`, flexShrink: 0, fontSize: "11px", color: isEvenMaand ? "#4A9EE0" : "#7A9AB5", textAlign: "center", overflow: "hidden", fontWeight: "bold", borderLeft: "2px solid rgba(255,255,255,0.12)", paddingLeft: "2px" }}>
                            {mNaam}
                          </div>
                        );
                      })}
                              ...
                              <div key={mIdx} style={{ display: "flex", gap: "1px", borderLeft: "2px solid rgba(255,255,255,0.12)", paddingLeft: "2px", paddingRight: "2px", background: isEvenMaand ? "rgba(255,255,255,0.015)" : "transparent" }}>
                                {Array.from({ length: aantalDagen }, (_, dIdx) => {
                                  ...
                                  if (isFeest) { bg = "rgba(224,85,85,0.25)"; dagType = "feestdag"; title = `${dagNaam} ${fmtDatum(dagStr)} · ${feestdagen.get(dagStr) || "Feestdag"}`; }
                                    ...
                                    if (aanvraagOpDag.status === "goedgekeurd") {
                                  ...
                                  return (
                                    <div key={dIdx} title={title} data-type={dagType} data-kleur={w.kleur} style={{ width: `${dagBreedte/3.5}px`, height: "24px", borderRadius: "2px", background: bg, flexShrink: 0 }} />
                                  );
                                })}
                              </div>
                            );
      ...
      <style>{`
        ...
        @media print {
          ...
          /* Hele pagina wit, niets zichtbaar behalve jaaroverzicht */
          html, body {
          ...
          /* Verberg alle directe children van de React root behalve het overzicht */
          body.printing-jaar #root > * { display: none !important; }
          body.printing-jaar .jaaroverzicht-print { display: block !important; }

          /* Fallback zonder body class */
          body:not(.printing-jaar) .jaaroverzicht-print { display: block !important; }
