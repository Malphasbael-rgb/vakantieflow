      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "32px 24px" }}>
        ...
        {adminSub === "rooster" && (() => {
          ...
          function buildRoosterVolgorde(wns) {
            ...
            const vast = wns.filter(w => !w.stagiair).sort((a, b) => (NAAM_POS[a.naam] ?? 99) - (NAAM_POS[b.naam] ?? 99));
            const result = [];
            for (const w of vast) {
              result.push(w);
          ...
          return (
            <div style={{ fontFamily:"Georgia, serif" }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:"14px", marginBottom:"14px", flexWrap:"wrap" }}>
                ...
                <span style={{ fontSize:"9px", color:"yellow", marginLeft:"8px" }}>{werknemers.filter(w=>!w.stagiair).map(w=>w.naam).join(" | ")}</span>
                <button onClick={() => {
