                                ...
                                <td key={w.id+deel}
                                  ...
                                  {afd ? (
                                    <div style={{ width:"100%", height:"100%", display:"flex", alignItems:"center", justifyContent:"center", position:"relative", overflow:"hidden" }}>
                                      <span style={{ fontSize: letter === "OPL" ? "8px" : "12px", fontWeight:"bold", color: verlof ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.7)", textDecoration: verlof ? "line-through" : "none" }}>{letter}</span>
