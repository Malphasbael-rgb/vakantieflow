    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0F1923 0%, #162233 50%, #0F1923 100%)", fontFamily: "Georgia, serif", color: "#E8EDF2" }}>
      ...
      {bevestigingToast && (
        ...
        {adminSub === "jaar" && (() => {
          ...
          function exportPDF() {
            // A4 landscape bruikbare hoogte: 210mm - 10mm margins = 200mm
            // Titelregel ~6mm + maandrij ~5mm = 11mm overhead → 189mm voor rijen
            const beschikbaarMM = 189;
            const rijHoogteMM = beschikbaarMM / aantalWerknemers;
            const rijHoogtePx = rijHoogteMM * 3.7796; // mm naar px
            ...
            stijl.textContent = `
              @media print {
                ...
                [data-type] { height: ${dagHoogte}px !important; width: 3px !important; }
