                            ...
                            return ["O","M"].map(deel => {
                              ...
                              return (
                                <td key={w.id+deel}
                                  ...
                                  style={{ background: bg || "transparent", border: afd && stagInOpleiding ? "2px solid #E67E22" : "1px solid rgba(255,255,255,0.05)", borderLeft: deel==="O" ? "2px solid rgba(255,255,255,0.35)" : "1px solid rgba(255,255,255,0.04)", padding:"2px", verticalAlign:"middle", textAlign:"center", height:"26px", position:"relative", cursor: afd ? "pointer" : "default", WebkitPrintColorAdjust:"exact", printColorAdjust:"exact" }}>
                                  {afd ? (
                                    <div style={{ width:"100%", height:"calc(100% - 0px)", display:"flex", alignItems:"center", justifyContent:"center", position:"relative", background: bg, borderRadius:"3px", overflow:"hidden", WebkitPrintColorAdjust:"exact", printColorAdjust:"exact" }}>
                                    ...
                                    <div style={{ width:"100%", height:"100%", display:"flex", alignItems:"center", justifyContent:"center", background: bg, borderRadius:"3px", WebkitPrintColorAdjust:"exact", printColorAdjust:"exact" }}>
      ...
      <style>{`
        ...
        @media print {
          ...
          * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
          ...
          body.rooster-print-active .rooster-print-container td > div {
