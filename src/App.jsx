                      ...
                      <div style={{ flex:1 }}>
                        ...
                        {(dagAudits.length > 0 || labBezoek.length > 0) && (
                          <div style={{ marginTop:"8px", paddingTop:"8px", borderTop:"1px solid rgba(255,255,255,0.06)", display:"flex", flexWrap:"wrap", gap:"6px" }}>
                            {dagAudits.map(a => (
                              <span key={a.id} style={{ fontSize:"10px", background:"rgba(230,126,34,0.12)", border:"1px solid rgba(230,126,34,0.25)", borderRadius:"6px", padding:"2px 8px", color:"#E67E22" }}>🔍 {a.bedrijf}</span>
                            ))}
                            {labBezoek.map(a => (
                              <span key={"lab-"+a.id} style={{ fontSize:"10px", background:"rgba(74,158,224,0.12)", border:"1px solid rgba(74,158,224,0.25)", borderRadius:"6px", padding:"2px 8px", color:"#4A9EE0" }}>🏭 {a.bedrijf}{a.labTijd ? ` · ${a.labTijd}` : ""}</span>
                            ))}
                          </div>
                        )}
                      </div>
