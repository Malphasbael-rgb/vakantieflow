        ...
        {adminSub === "rooster" && (() => {
          ...
          function buildRoosterVolgorde(wns) {
            ...
            const NAAM_POS = {
              ...
              "Roos Van Wijnen": 2,
              "Nick Roskam": 3,
              "Niels De Vries": 4,  "Niels de Vries": 4,
              "Monique Breijmer": 5,
              "Alinda Postma": 6,
              "Anita Dijkstra": 7,
              "Erwin Kooistra": 8,
              ...
              "Suleika Ramdien": 14,
              "Diana Wijbenga": 15,
              "Xamira De Haan": 16, "Xamira de Haan": 16,
              "Ylva": 17,
              "Niels Rosenau": 18,
              "Bart Reinsma": 19,
              "Dylan Breebaard": 20, "Dylan Breebaard": 20,
            };
          ...
          return (
            <div style={{ fontFamily:"Georgia, serif" }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:"14px", marginBottom:"14px", flexWrap:"wrap" }}>
                ...
                <span style={{ fontSize:"9px", color:"yellow", marginLeft:"8px" }}>{werknemers.map(w=>`${w.naam}(s:${w.stagiair??'null'})`).join(" | ")}</span>
                <button onClick={() => {
