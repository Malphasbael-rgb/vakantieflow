                                ...
                                <td key={w.id+deel}
                                  ...
                                  {(afd || dienstreis || verlof) ? (
                                    <svg width="100%" height="26" style={{ display:"block", position:"absolute", top:0, left:0 }} xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <text x="50%" y="17" textAnchor="middle" fontSize={letter==="OPL"?"7":"11"} fontWeight="bold" fill={verlof?"rgba(255,255,255,0.6)":"rgba(0,0,0,0.75)"} fontFamily="Georgia,serif" style={{ textDecoration: verlof ? "line-through" : "none" }}>
