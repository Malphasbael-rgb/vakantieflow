    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0F1923 0%, #162233 60%, #0F1923 100%)", fontFamily: "Georgia, serif", color: "#E8EDF2" }}>
      ...
      <div style={{ maxWidth: "700px", margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={{ display: "flex", gap: "4px", marginBottom: "24px" }}>
          {[{ key: "aanvragen", label: "📋 Mijn aanvragen" }, { key: "archief", label: "📦 Archief" }, { key: "nieuw", label: "✏️ Nieuwe aanvraag" }, { key: "rooster", label: "📅 Mijn rooster" }, ...(werknemer.id === 13 ? [{ key: "audits", label: "🔍 Audits" }] : [])].map(t => (
                  ...
                  return (
                    <div key={dagStr} style={{
                      ...
                      <div style={{ flex:1 }}>
                        ...
                        {dagAudits.map(a => (
                          <div key={a.id} style={{ background:"rgba(230,126,34,0.12)", border:"1px solid rgba(230,126,34,0.3)", borderRadius:"8px", padding:"6px 10px", marginBottom:"6px", display:"flex", alignItems:"center", gap:"8px" }}>
                            <span style={{ fontSize:"13px" }}>🔍</span>
                            <div>
                              <div style={{ fontSize:"12px", fontWeight:"bold", color:"#E67E22" }}>Audit: {a.bedrijf}</div>
                              {a.opmerking && <div style={{ fontSize:"10px", color:"rgba(230,126,34,0.7)" }}>{a.opmerking}</div>}
                            </div>
                          </div>
                        ))}
                        {labBezoek.map(a => (
                          <div key={"lab-"+a.id} style={{ background:"rgba(74,158,224,0.12)", border:"1px solid rgba(74,158,224,0.35)", borderRadius:"8px", padding:"6px 10px", marginBottom:"6px", display:"flex", alignItems:"center", gap:"8px" }}>
                            <span style={{ fontSize:"13px" }}>🏭</span>
                            <div>
                              <div style={{ fontSize:"12px", fontWeight:"bold", color:"#4A9EE0" }}>Labbezoek: {a.bedrijf}{a.labTijd ? ` om ${a.labTijd}` : ""}</div>
                              {a.opmerking && <div style={{ fontSize:"10px", color:"rgba(74,158,224,0.7)" }}>{a.opmerking}</div>}
                            </div>
                          </div>
                        ))}
        ...
        {tab === "audits" && werknemer.id === 13 && (() => {
          ...
          return (
            <div style={{ display:"flex", flexDirection:"column", gap:"20px" }}>
              {/* Nieuwe audit invoeren */}
              <div style={{ background:"linear-gradient(135deg,#1A2C42,#162233)", borderRadius:"16px", padding:"24px", border:"1px solid rgba(255,255,255,0.06)" }}>
                <div style={{ fontSize:"13px", color:"#7A9AB5", letterSpacing:"1.5px", textTransform:"uppercase", marginBottom:"18px" }}>🔍 Nieuwe audit toevoegen</div>
                <div style={{ display:"flex", flexDirection:"column", gap:"14px" }}>
                  ...
                  <div style={{ background:"rgba(74,158,224,0.06)", borderRadius:"10px", padding:"14px", border:"1px solid rgba(74,158,224,0.12)" }}>
                    ...
                    <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"12px" }}>
                      ...
                      <div>
                        ...
                        <input type="time" value={auditForm.labTijd} onChange={e => setAuditForm(f=>({...f,labTijd:e.target.value}))} style={inputStyle} />
                      </div>
                    </div>
                  </div>
                  <div>
                  ...
                  <button onClick={voegAuditToe} style={{ padding:"13px", borderRadius:"10px", border:"none", cursor:"pointer", background:"linear-gradient(135deg,#4A9EE0,#2D6FA8)", color:"#fff", fontSize:"14px", fontWeight:"bold", fontFamily:"Georgia,serif" }}>
                    Audit toevoegen →
                  </button>
                </div>
              </div>
