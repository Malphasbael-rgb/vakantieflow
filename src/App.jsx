    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0F1923 0%, #162233 50%, #0F1923 100%)", fontFamily: "Georgia, serif", color: "#E8EDF2" }}>
      ...
      <style>{`
        ...
        @media print {
          ...
          /* Verberg alles behalve het jaaroverzicht */
          body * { visibility: hidden; }
          .jaaroverzicht-print, .jaaroverzicht-print * { visibility: visible; }

          /* Positioneer het jaaroverzicht */
          .jaaroverzicht-print {
            position: fixed;
            top: 0; left: 0;
            width: 277mm;
          ...
          /* Schaal zodat alle 365 dagen passen */
          .jaar-scroll {
          ...
          /* Namen leesbaar zwart */
          .naam-label { color: #111 !important; }

          /* Maandscheiding zichtbaar op wit */
          .jaar-scroll div[style*="borderLeft"] {
            border-left-color: #ccc !important;
          }

          /* Lichte kleuren per dagtype */
          [data-type="werkdag"]  { background: #f0f0f0 !important; }
          [data-type="weekend"]  { background: #e0e0e0 !important; }
          [data-type="feestdag"] { background: #ffcccc !important; }
          [data-type="schoolvak"]{ background: #ccf0cc !important; }
          [data-type="verlof"]   { background: #ffe066 !important; }
          [data-type="wacht"]    { background: #a8d4f5 !important; }
