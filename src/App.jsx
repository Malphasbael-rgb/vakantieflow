                            ...
                            return ["O","M"].map(deel => {
                              ...
                              return (
                                <td key={w.id+deel}
                                  ...
                                  style={{ border: afd && stagInOpleiding ? "2px solid #E67E22" : "1px solid rgba(255,255,255,0.05)", borderLeft: deel==="O" ? "2px solid rgba(255,255,255,0.35)" : "1px solid rgba(255,255,255,0.04)", padding:"0", verticalAlign:"middle", textAlign:"center", height:"26px", position:"relative", cursor: afd ? "pointer" : "default" }}>
                                  {(afd||dienstreis||verlof) && bg && (
                                    <div style={{ position:"absolute", inset:0, backgroundColor: bg, WebkitPrintColorAdjust:"exact", printColorAdjust:"exact", colorAdjust:"exact", zIndex:0 }} />
                                  )}
                                  <div style={{ position:"relative", zIndex:1, width:"100%", height:"100%", display:"flex", alignItems:"center", justifyContent:"center" }}>
                                  {afd ? (
                                    <>
                                      <span style={{ fontSize: letter === "OPL" ? "7px" : "11px", fontWeight:"bold", color: verlof ? "rgba(255,255,255,0.6)" : "rgba(0,0,0,0.7)", textDecoration: verlof ? "line-through" : "none" }}>{letter}</span>
                                      {verlof && <span style={{ position:"absolute", top:"1px", right:"2px", fontSize:"7px" }}>🌴</span>}
                                    </>
                                  ) : dienstreis ? (
                                    <span style={{ fontSize:"8px", fontWeight:"bold", color:"rgba(0,0,0,0.7)" }}>DR</span>
                                  ) : verlof ? (
      ...
      <style>{`
        ...
        @media print {
          ...
          * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
          ...
          body.rooster-print-active .rooster-print-container td [style*="position: absolute"],
          body.rooster-print-active .rooster-print-container td [style*="position:absolute"] {
            -webkit-print-color-adjust: exact !important;
            print-color-adjust: exact !important;
            color-adjust: exact !important;
