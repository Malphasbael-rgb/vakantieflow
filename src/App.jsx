                ...
                <div key={a.id} style={{ background: "linear-gradient(135deg, #1A2C42, #162233)", borderRadius: "14px", padding: "20px", border: conflict ? "1px solid rgba(224,85,85,0.4)" : "1px solid rgba(255,255,255,0.06)", boxShadow: "0 4px 16px rgba(0,0,0,0.2)" }}>
                  ...
                  {a.status !== "in behandeling" && (
                    <div style={{ marginTop: "10px" }}>
                      <button onClick={() => setConfirmModal({ vraag: "Aanvraag archiveren? De aanvraag blijft bewaard maar verdwijnt uit je overzicht.", onJa: () => setAanvragen(prev => prev.map(x => x.id === a.id ? { ...x, gearchiveerdDoorWerknemer: true } : x)) })}
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0F1923 0%, #162233 50%, #0F1923 100%)", fontFamily: "Georgia, serif", color: "#E8EDF2" }}>
            ...
            <div style={{ fontFamily:"Georgia, serif" }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:"14px", marginBottom:"14px", flexWrap:"wrap" }}>
                ...
                <button onClick={() => {
                    ...
                    window.print();
                    setTimeout(() => document.body.classList.remove("rooster-print-active"), 1500);
      ...
      <style>{`
        ...
        /* Rooster afdrukken klasse */
        .rooster-afdrukken body * { visibility: hidden !important; }
        .rooster-afdrukken .rooster-print-container,
        .rooster-afdrukken .rooster-print-container * { visibility: visible !important; }
        .rooster-afdrukken .rooster-print-container {
        ...
        @media print {
          ...
          body.rooster-print-active .rooster-print-container colgroup col {
